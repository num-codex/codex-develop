...
repos=("codex-feasibility-gui" "codex-feasibility-backend" "codex-gecco-to-ui-profiles" "codex-keycloak" "codex-processes-ap2" "codex-aktin-broker" "codex-sq2cql" "num-knoten" "broker" "codex-flare" "odm2fhir")
baseDir=$(pwd)
